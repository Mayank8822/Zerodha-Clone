     ...
     <footer style={{ backgroundColor: "rgb(250, 250, 250)" }}>
      <div className="container border-top mt-5">
        <div className="row mt-5 ">
          ...
          <div className="col">
            <p>Quick Links</p>
            <a href="" style={{textDecoration:"none"}}>Upcoming IPO</a>
            <br />
            <a href="" style={{textDecoration:"none"}}>Brokerage charges</a>
            <br />
            <a href="" style={{textDecoration:"none"}}>Market Holiday</a>
            <br />
            <a href="" style={{textDecoration:"none"}}>Economic Calender</a>
            <br />
             <a href="" style={{textDecoration:"none"}}>Calculator</a>
            <br />
          </div>
        </div>
